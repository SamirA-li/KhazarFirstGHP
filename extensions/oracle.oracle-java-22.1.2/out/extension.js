...
const jdkDownloader_1 = require("./jdkDownloader");
...
function findJDK(onChange) {
    ...
    function find() {
        let nbJdk = vscode_1.workspace.getConfiguration('jdk').get('jdkhome');
        if (nbJdk) {
            return nbJdk;
        }
...
function activate(context) {
    ...
    (0, runConfiguration_1.initializeRunConfiguration)().then(initialized => {
        if (initialized) {
            context.subscriptions.push(vscode.debug.registerDebugConfigurationProvider('jdk', runConfiguration_1.runConfigurationProvider));
    ...
    // register commands
    context.subscriptions.push(vscode_1.commands.registerCommand(exports.COMMAND_PREFIX + '.workspace.new', (ctx) => __awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c, _d;
        let c = yield client;
        const commands = yield vscode.commands.getCommands();
        if (commands.includes(exports.COMMAND_PREFIX + '.new.from.template')) {
            ...
            const res = yield vscode.commands.executeCommand(exports.COMMAND_PREFIX + '.new.from.template', (_a = contextUri(ctx)) === null || _a === void 0 ? void 0 : _a.toString(), (_d = (_c = (_b = vscode.window.activeTextEditor) === null || _b === void 0 ? void 0 : _b.document) === null || _c === void 0 ? void 0 : _c.uri) === null || _d === void 0 ? void 0 : _d.toString());
    ...
    context.subscriptions.push(vscode.commands.registerCommand(exports.COMMAND_PREFIX + ".delete.cache", () => __awaiter(this, void 0, void 0, function* () {
        ...
        if (userDir && fs.existsSync(userDir)) {
            const confirmation = yield vscode.window.showInformationMessage('Are you sure you want to delete cache for this workspace?', 'Yes', 'Cancel');
            if (confirmation === 'Yes') {
                yield fs.promises.rmdir(userDir, { recursive: true });
                const res = yield vscode.window.showInformationMessage('Cache cleared successfully for this workspace', 'Reload window');
    ...
    context.subscriptions.push(vscode.commands.registerCommand(exports.COMMAND_PREFIX + ".download.jdk", () => __awaiter(this, void 0, void 0, function* () { (0, jdkDownloader_1.openJDKSelectionView)(log); })));
    ...
    context.subscriptions.push(vscode_1.commands.registerCommand(exports.COMMAND_PREFIX + '.java.goto.super.implementation', () => __awaiter(this, void 0, void 0, function* () {
        var _l;
        if (((_l = vscode_1.window.activeTextEditor) === null || _l === void 0 ? void 0 : _l.document.languageId) !== "java") {
            return;
        }
...
function isNbJavacDisabled() {
    var _a;
    return (_a = vscode_1.workspace.getConfiguration('jdk')) === null || _a === void 0 ? void 0 : _a.get('advanced.disable.nbjavac');
}
function doActivateWithJDK(specifiedJDK, context, log, notifyKill, setClient) {
    ...
    const netbeansConfig = vscode_1.workspace.getConfiguration('jdk');
    ...
    let ideRunning = new Promise((resolve, reject) => {
        ...
        let extras = ["--modules", "--list", "-J-XX:PerfMaxStringConstLength=10240"];
        if (isDarkColorTheme()) {
            extras.push('--laf', 'com.formdev.flatlaf.FlatDarkLaf');
        }
        let serverVmOptions = vscode_1.workspace.getConfiguration('jdk').get("serverVmOptions", []);
        ...
        p.on('close', function (code) {
            ...
            if ((stdErr === null || stdErr === void 0 ? void 0 : stdErr.match(/Cannot find java/)) || os.type() === "Windows_NT") {
                vscode.window.showInformationMessage("No JDK found!", "Download JDK and setup automatically").then(selection => {
                    if (selection === 'Download JDK and setup automatically') {
                        (0, jdkDownloader_1.openJDKSelectionView)(log);
                    }
                });
            }
            if (stdOut != null) {
    ...
    ideRunning.then(() => {
        ...
        let c = new NbLanguageClient('java', 'Oracle Java SE', connection, log, clientOptions);
        ...
        if (msg.startsWith(NO_JAVA_SUPPORT)) {
            if (isNbJavacDisabled()) {
                ...
                vscode_1.window.showErrorMessage(message, enable, settings).then(reply => {
                    if (enable === reply) {
                        vscode_1.workspace.getConfiguration().update('jdk.advanced.disable.nbjavac', false);
                    }
